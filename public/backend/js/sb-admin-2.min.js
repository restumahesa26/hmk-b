...
$(".add2").click(function () {
    ...
    $("#prokerTable").append('<tr><td><input type="text" name="proker[]" placeholder="Masukkan Proker" class="form-control"></td><td><button type="button" class="remove-tr2 btn btn-danger" >Hapus</button></td></tr>');
