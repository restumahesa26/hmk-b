...
@section('title')
    <title> Admin - Edit Data Alumni </title>
@endsection
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="" class="btn btn-sm btn-primary shadow-sm">
            <i class="fas fa-plus fa-sm text-white-50"></i> Edit Data Alumni
        </a>
    </div>
    ...
    <div class="card-show">
        <div class="card-body">
            <form action="{{ route('data-alumni.update', $item->id) }}" method="POST" enctype="multipart/form-data" class="form" id="form"> 
                @method('PUT')
                @csrf
                ...
                <div class="form-group">
                    ...
                    <img src="{{ asset('storage/images/foto-alumni/'. $item-> foto) }}" style="width:200px; height:200px;" class="img-thumbnail">
