...
@section('title')
    <title> Admin - Tambah Data Anggota Aktif </title>
@endsection
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-light">
                ...
                <li class="breadcrumb-item"><a href="{{ route('data-anggota-aktif.index') }}">Data Anggota Aktif</a></li>
    ...
    <div class="card-show">
        <div class="card-body">
            <form action="{{ route('data-anggota-aktif.store') }}" method="POST" enctype="multipart/form-data" class="form" id="form">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input id="jurusan" ="text" class="form-control @error('jurusan') is-invalid @enderror" name="jurusan" placeholder="Jurusan" value="{{ old('jurusan') }}">
                    @error('jurusan')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
