...
@section('title')
<title> Admin - Data Anggota Aktif </title>
@endsection
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Data Anggota Aktif</h1>
        <a href="{{ route('data-anggota-aktif.create') }}" class="btn btn-sm btn-primary shadow-sm">
    ...
    <div class="d-sm-flex align-items-center justify-content-between">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-light">
                ...
                <li class="breadcrumb-item active" aria-current="page">Data Anggota Aktif</li>
            </ol>
        </nav>
        <a href="{{ route('data-anggota-aktif.index') }}" class="btn btn-info">Refresh</a>
    </div>
    ...
    <div class="input-group mb-3">
        <div class="dropdown no-arrow">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="{{ route('sort1') }}">Nama</a>
                <a class="dropdown-item" href="{{ route('sort7') }}">Jurusan</a>
                <a class="dropdown-item" href="{{ route('sort2') }}">Kampus</a>
                <a class="dropdown-item" href="{{ route('sort3') }}">Angkatan</a>
            </div>
        </div>
        <input type="text" class="form-control input-group-text" name="keyword"
            placeholder="Cari berdasarkan nama, angkatan, asal kampus" value="{{ old('keyword') }}" id="keyword">
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover" width="100%" cellspacing="0">
                ...
                <tbody id="tbody">
                    ...
                    <td>{{ $item-> angkatan }}</td>
                    <td>
                        <a href="{{ route('data-anggota-aktif.show', $item->id) }}" class="btn btn-dark">
                            <i class="fa fa-eye"></i>
                        </a>
                        <a href="{{ route('data-anggota-aktif.edit', $item->id) }}" class="btn btn-info editData" data-name="{{ $item-> nama }}">
                            <i class="fa fa-pencil-alt"></i>
                        </a>
                        <form action="{{ route('data-anggota-aktif.destroy', $item->id) }}" method="POST"
                            class="d-inline">
                            @csrf
                            @method('delete')
                        ...
                        <a href="{{ route('data-anggota-aktif.move', $item->id) }}" class="btn btn-warning pindahData" data-name="{{ $item-> nama }}">
...
<script type="text/javascript">
    ...
    $('.pindahData').on('click', function (event) {
        ...
        swal({
                ...
                text: "Pindahkan data anggota aktif menjadi alumni",
                type: "info",
                showCancelButton: true,
