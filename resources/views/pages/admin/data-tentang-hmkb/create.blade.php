...
@section('title')
    <title> Admin - Tambah Data Tentang HMK-B </title>
@endsection
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('tentang-hmkb.create') }}" class="btn btn-sm btn-primary shadow-sm">
    ...
    <div class="card-show">
        <div class="card-body">
            <form action="{{ route('tentang-hmkb.store') }}" method="POST" class="form" id="form">
                @csrf
                <div class="form-group">
                    <label for="dataTentang">Data</label>
                    <textarea name="dataTentang" id="dataTentang" cols="30" rows="10" class="form-control @error('dataTentang') is-invalid @enderror" placeholder="Data Tentang HMK-B" value="{{ old('dataTentang') }}"></textarea>
                    @error('dataTentang')
